...
class Reflector(Agent):
    ...
    def _prompt_reflection(self, input: str, scratchpad: str) -> str:
        ...
        return self.apply_reflection_response(reflection_prompt, reflection_response)

    def apply_reflection_response(self, reflection_prompt: str, reflection_response: str) -> str:
    ...
    def apply_batch_response(self, input: str, scratchpad: str, reflection_response: str) -> str:
        reflection_prompt = self._build_reflector_prompt(input, scratchpad)
        ...
        if self.reflection_strategy == ReflectionStrategy.LAST_ATTEMPT:
            ...
            self.reflections.append(self.apply_reflection_response(reflection_prompt, reflection_response))
            ...
            self.reflections_str = format_last_attempt(input, scratchpad, self.prompts['last_trial_header'])
            self.reflections = self.apply_reflection_response(reflection_prompt, reflection_response)
