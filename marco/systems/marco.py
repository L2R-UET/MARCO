...
from marco.factories import DefaultAgentFactory, ConfigManager
from marco.components import MARCOOrchestrator, AgentCoordinator
from marco.agents.base import Agent
from marco.utils import parse_answer, parse_action, format_chat_history, duration_tracker
...
class MARCOSystem(System):
    ...
    def init(self, *args, **kwargs) -> None:
        ...
        self.orchestrator = MARCOOrchestrator(config_manager, self.agent_coordinator)
            ...
            if self.enable_reflection_rerun:
                ...
                while should_continue_reflecting and reflection_count < max_reflections:
                    ...
                    if position_before > 0 and position_after > 0 and position_after < position_before:
                        ...
                        logger.info(f"Reflection did NOT change position (before: {position_before}, after: {position_after})")
    ...
    def _solving_phase(self) -> str:
        ...
        self.log(f"**MARCO Final Solution:**\n{solution}", agent=self.solver)
        ...
        logger.info(f"MARCO Final Answer: {final_answer} | Ground Truth: {self.gt_answer}")
